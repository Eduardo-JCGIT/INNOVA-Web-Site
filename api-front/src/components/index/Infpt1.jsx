    ...
    return(
        <div>
            ...
            <section className=' container_global cont_info_ind'>
                ...
                <br/>
                <h3 className='txt_bold_tittle'> <PiFireSimpleFill className='Cg_color_item'/> Grabaciónes</h3>
            ...
            <section className='container_global cont_info_ind2'>
                ...
                <br/>
                <p><PiFireSimpleFill className='Cg_color_item'/> Tu universidad ONLINE más cerca de ti, INNOVA cuenta clubes de estudios sabatinos presenciales donde se analizan a detalle cada tema, con un maestro especialista en la materia.</p>
                <br/>
